...
extern int jump896divsteps(int minusdelta, int *M, int *f, int *g);
void gf_polymul_960x960(int *h, int *f, int *g);
void gf_polymul_960x960_2x2_x_2x2 (int *M, int *M1, int *M2); // M = M2 x M1 
int jump1920divsteps(int minusdelta, int *M, int *f, int *g);
...
void gf_polymul_960x960_2x2_x_2x2 (int *M, int *M1, int *M2){ //only v = g^-1 mod f
    int i;
    int T, *X, *Y, *Z;
    int B1920[961], B1920_1[961];
    int *BB1920 = (int *)((void *)B1920 + 2);
    B1920[0] = 0;
    B1920_1[1] = 0;
